export default {
  ...
  PARTY_LABEL: "编队",
  TRIPLE_AXIS_LABEL: "轴 {n}",
  TRIPLE_TOTAL_LABEL: "三轴合计基础分: ",
  ...
  FILTER_CHARACTER_OBTAIN_EVENT: "活动",
  ...
  FILTER_EFFECT_PERFORMANCE_DUPLICATE_UP: "演技力提升",
  ...
  FILTER_EFFECT_SENSE_LIGHT_SUPPORT:
    '加<span class="sense-star" data-sense-type="support"></span>光',
  FILTER_EFFECT_SENSE_LIGHT_CONTROL:
    '加<span class="sense-star" data-sense-type="control"></span>光',
  FILTER_EFFECT_SENSE_LIGHT_AMPLIFICATION:
    '加<span class="sense-star" data-sense-type="amplification"></span>光',
  FILTER_EFFECT_SENSE_LIGHT_SPECIAL:
    '加<span class="sense-star" data-sense-type="special"></span>光',
  FILTER_EFFECT_SENSE_LIGHT_VARIABLE:
    '加<span class="sense-star" data-sense-type="variable"></span>光',
  ...
  FILTER_EFFECT_CONDITION_COMPANY: "剧团",
  FILTER_EFFECT_CONDITION_ATTRIBUTE: "属性",
  FILTER_EFFECT_CONDITION_NONE: "无",
  ...
  LOG_WARNING_EFFECT_TRIGGER_NOT_IMPLEMENTED:
    "未支持的效果触发：{trigger} @ {range} ({id})",
  LOG_WARNING_EFFECT_BRANCH_NOT_IMPLEMENTED:
    "未支持的分支条件：{condition} ({id})",
