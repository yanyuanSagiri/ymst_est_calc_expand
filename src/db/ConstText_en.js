export default {
  ...
  SENSE_NOTATION_TAB_TRIPLE: "Triple Cast",

  ALBUM_LEVEL_LABEL: "Album level: ",
  PARTY_LABEL: "Party edit",
  TRIPLE_AXIS_LABEL: "Axis {n}",
  TRIPLE_TOTAL_LABEL: "Total Base Score: ",
  ...
  FILTER_EFFECT_SENSE_LIGHT_SUPPORT:
    'Add <span class="sense-star" data-sense-type="support"></span>',
  FILTER_EFFECT_SENSE_LIGHT_CONTROL:
    'Add <span class="sense-star" data-sense-type="control"></span>',
  FILTER_EFFECT_SENSE_LIGHT_AMPLIFICATION:
    'Add <span class="sense-star" data-sense-type="amplification"></span>',
  FILTER_EFFECT_SENSE_LIGHT_SPECIAL:
    'Add <span class="sense-star" data-sense-type="special"></span>',
  FILTER_EFFECT_SENSE_LIGHT_VARIABLE:
    'Add <span class="sense-star" data-sense-type="variable"></span>',
  ...
  LOG_WARNING_EFFECT_NOT_IMPLEMENTED:
    "Effect type not implemented: {type} ({id})",
  LOG_WARNING_EFFECT_TRIGGER_NOT_IMPLEMENTED:
    "Effect trigger not implemented: {trigger} @ {range} ({id})",
  LOG_WARNING_EFFECT_BRANCH_NOT_IMPLEMENTED:
    "Branch condition not implemented: {condition} ({id})",
  LOG_WARNING_INACCURATE_SCORE_GAIN_ON_SCORE:
    "** Bonus based on current score cannot be accurately calculated",
  LOG_WARNING_EFFECT_SCORE_GAIN_TYPE_NOT_IMPLEMENTED:
    "Score gain type not implemented: {type} ({id})",
  UNDEFINED_STRING: "Missing text template: {0}",
  ALBUM_ENABLED_EFFECTS: "Album effects enabled",
};
