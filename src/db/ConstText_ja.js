export default {
  ...
  SENSE_NOTATION_TAB_TRIPLE: "三幕公演",

  ALBUM_LEVEL_LABEL: "アルバムレベル：",
  PARTY_LABEL: "編成",
  TRIPLE_AXIS_LABEL: "軸 {n}",
  TRIPLE_TOTAL_LABEL: "三軸合計ベーススコア: ",
  ...
  FILTER_CHARACTER_OBTAIN_EVENT: "イベント",
  ...
  FILTER_EFFECT_PERFORMANCE_DUPLICATE_UP: "演技力アップ",
  ...
  FILTER_EFFECT_SENSE_LIGHT_SUPPORT:
    '<span class="sense-star" data-sense-type="support"></span>追加',
  FILTER_EFFECT_SENSE_LIGHT_CONTROL:
    '<span class="sense-star" data-sense-type="control"></span>追加',
  FILTER_EFFECT_SENSE_LIGHT_AMPLIFICATION:
    '<span class="sense-star" data-sense-type="amplification"></span>追加',
  FILTER_EFFECT_SENSE_LIGHT_SPECIAL:
    '<span class="sense-star" data-sense-type="special"></span>追加',
  FILTER_EFFECT_SENSE_LIGHT_VARIABLE:
    '<span class="sense-star" data-sense-type="variable"></span>追加',
  ...
  FILTER_EFFECT_CONDITION_COMPANY: "劇団",
  FILTER_EFFECT_CONDITION_ATTRIBUTE: "属性",
  FILTER_EFFECT_CONDITION_NONE: "なし",
  ...
  LOG_WARNING_EFFECT_TRIGGER_NOT_IMPLEMENTED:
    "効果の条件支援していない：{trigger} @ {range} ({id})",
  LOG_WARNING_EFFECT_BRANCH_NOT_IMPLEMENTED:
    "分岐条件支援していない：{condition} ({id})",
  LOG_WARNING_INACCURATE_SCORE_GAIN_ON_SCORE:
    "** 現在のスコアに基づくボーナスは正確に計算できません",
  LOG_WARNING_EFFECT_SCORE_GAIN_TYPE_NOT_IMPLEMENTED:
    "スコアボーナスの種類支援していない：{type} ({id})",
  UNDEFINED_STRING: "不足しているテキスト：{0}",
  ALBUM_ENABLED_EFFECTS: "アルバムの効果を有効化",
};
